 ...
 */
Maze2.Blocks.MOVEMENT_HUE = 290;

/**
 * HSV hue for loop block.
 */
Maze2.Blocks.LOOPS_HUE = 120;

/**
 * Common HSV hue for all logic blocks.
 */
Maze2.Blocks.LOGIC_HUE = 210;

/**
 * Left turn arrow to be appended to messages.
 */
Maze2.Blocks.LEFT_TURN = ' \u21BA';

/**
 * Left turn arrow to be appended to messages.
 */
Maze2.Blocks.RIGHT_TURN = ' \u21BB';
...
Blockly.Blocks['maze_moveForward'] = {
  ...
  init: function() {
    this.jsonInit({
      ...
      "nextStatement": null,
      "colour": Maze2.Blocks.MOVEMENT_HUE,
...
Blockly.Blocks['maze_turn'] = {
  ...
  init: function() {
    ...
    DIRECTIONS[0][0] += Maze2.Blocks.LEFT_TURN;
    DIRECTIONS[1][0] += Maze2.Blocks.RIGHT_TURN;
    this.setColour(Maze2.Blocks.MOVEMENT_HUE);
...
Blockly.Blocks['maze_if'] = {
  ...
  init: function() {
    ...
    // Append arrows to direction messages.
    DIRECTIONS[1][0] += Maze2.Blocks.LEFT_TURN;
    DIRECTIONS[2][0] += Maze2.Blocks.RIGHT_TURN;
    this.setColour(Maze2.Blocks.LOGIC_HUE);
    this.appendDummyInput()
        .appendField(new Blockly.FieldDropdown(DIRECTIONS), 'DIR');
...
Blockly.Blocks['maze_forever'] = {
   ...
   */
  init: function() {
    this.setColour(Maze2.Blocks.LOOPS_HUE);
    this.appendDummyInput()
        .appendField(BlocklyGames.getMsg('Maze_repeatUntil'))
        .appendField(new Blockly.FieldImage(Maze2.SKIN.marker, 12, 16));
    this.appendStatementInput('DO')
        .appendField(BlocklyGames.getMsg('Maze_doCode'));
    this.setPreviousStatement(true);
